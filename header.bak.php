...
<link type="text/css" media="screen" href="<?php bloginfo('template_url'); ?>/css/autoptimize_e2.css" rel="stylesheet">
<link type="text/css" media="all" href="<?php bloginfo('template_url'); ?>/css/autoptimize_9c.css" rel="stylesheet">
<title><?php wp_title(); ?>-<?php bloginfo('name'); ?></title>
<link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/images/favicon.ico">
<link rel="alternate" type="application/rss+xml" title="公司网站名称 RSS Feed" href="./feed/">
...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/stickUp.min.js"></script>
...
<body class="custom-background">
            ...
            <div class="inner"><div class="topbar-lt"><p>我们是国内最优秀的高端网站定制团队</p></div><div class="topbar-rt"> <a href="http://biz.wpyou.com/about">关于我们</a> <a href="http://biz.wpyou.com/contact">联系我们</a></div></div></section>
            
            <header class="header">
            
            <div class="inner">
            <h1 class="logo fadeInLeft wow animated animated" style="visibility: visible;">
            <a href="./test_files/test.htm" rel="home">
            <img src="<?php bloginfo('template_url'); ?>/images/logo.jpg" alt="公司网站名称"></a></h1> <a id="btn-so"></a><div id="mobile-nav"> <a id="mobile-menu"></a> <a id="mobile-so"></a></div>
            ...
            <div id="search-box"><form method="get" id="searchform" action="./test_files/test.htm"> <input type="text" name="s" id="ls" class="searchInput" placeholder="输入关键字" x-webkit-speech=""> <input type="submit" id="searchsubmit" title="搜索" value="搜索"></form></div></div> </header>     